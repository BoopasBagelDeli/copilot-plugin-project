...
<#
.SYNOPSIS
Deploy AppInsightsTelemetryExtension Module

.DESCRIPTION
Deploys the AppInsightsTelemetryExtension plugin module to Power Platform with enterprise security.
...
Write-Host "⚙️ Deploying AppInsightsTelemetryExtension Module" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan

# Function to deploy connector
function Deploy-AppInsightsTelemetryExtensionConnector {
    Write-Host "
🔌 Deploying Power Platform connector..." -ForegroundColor Green
    ...
    try {
        ...
        if ($LASTEXITCODE -eq 0) {
            Write-Host "   ✅ AppInsightsTelemetryExtension connector deployed successfully!" -ForegroundColor Green
...
function Test-AppInsightsTelemetryExtensionConnector {
    Write-Host "
🧪 Testing connector functionality..." -ForegroundColor Green
    
    try {
        # Test health endpoint
        $healthUrl = "https://copilot-plugin-func-f46zzw7hhsh2q.azurewebsites.net/api/appinsightstelemetryextension/health"
...
function Show-NextSteps {
    Write-Host "
📋 Next Steps for AppInsightsTelemetryExtension" -ForegroundColor Cyan
    Write-Host "=============================" -ForegroundColor Cyan
...
1. 🔧 Test Your Connector:" -ForegroundColor Yellow
    ...
    Write-Host "   • Find 'AppInsightsTelemetryExtension' connector" -ForegroundColor White
...
2. 🎯 Create Flows:" -ForegroundColor Yellow
    ...
    Write-Host "   • Use 'AppInsightsTelemetryExtension' connector in new flows" -ForegroundColor White
    Write-Host "   • Available operations: 3 endpoints" -ForegroundColor White
    
    Write-Host "
3. 📱 Build Apps:" -ForegroundColor Yellow
    Write-Host "   • Power Apps: https://make.powerapps.com/" -ForegroundColor White
    Write-Host "   • Add 'AppInsightsTelemetryExtension' as data source" -ForegroundColor White
...
4. 🤖 M365 Copilot Integration:" -ForegroundColor Yellow
    ...
    Write-Host "   • Category: Custom" -ForegroundColor White
}

# Main deployment execution
function Main {
    Write-Host "
🎯 Starting AppInsightsTelemetryExtension deployment..." -ForegroundColor Green
    
    # Deploy connector
    $connectorDeployed = Deploy-AppInsightsTelemetryExtensionConnector
...
❌ Deployment failed!" -ForegroundColor Red
    ...
    # Test connector
    $connectorTested = Test-AppInsightsTelemetryExtensionConnector
...
⚠️  Connector deployed but health check failed" -ForegroundColor Yellow
    ...
    Write-Host "
🎉 AppInsightsTelemetryExtension deployment complete!" -ForegroundColor Green
    Write-Host "⚙️ Your AppInsightsTelemetryExtension plugin is ready to use!" -ForegroundColor Green
}
