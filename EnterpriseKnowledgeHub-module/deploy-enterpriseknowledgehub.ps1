...
<#
.SYNOPSIS
Deploy EnterpriseKnowledgeHub Module

.DESCRIPTION
Deploys the EnterpriseKnowledgeHub plugin module to Power Platform with enterprise security.
...
Write-Host "🔍 Deploying EnterpriseKnowledgeHub Module" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan

# Function to deploy connector
function Deploy-EnterpriseKnowledgeHubConnector {
    Write-Host "
🔌 Deploying Power Platform connector..." -ForegroundColor Green
    ...
    try {
        ...
        if ($LASTEXITCODE -eq 0) {
            Write-Host "   ✅ EnterpriseKnowledgeHub connector deployed successfully!" -ForegroundColor Green
...
function Test-EnterpriseKnowledgeHubConnector {
    Write-Host "
🧪 Testing connector functionality..." -ForegroundColor Green
    
    try {
        # Test health endpoint
        $healthUrl = "https://copilot-plugin-func-f46zzw7hhsh2q.azurewebsites.net/api/enterpriseknowledgehub/health"
...
function Show-NextSteps {
    Write-Host "
📋 Next Steps for EnterpriseKnowledgeHub" -ForegroundColor Cyan
    Write-Host "=============================" -ForegroundColor Cyan
...
1. 🔧 Test Your Connector:" -ForegroundColor Yellow
    ...
    Write-Host "   • Find 'EnterpriseKnowledgeHub' connector" -ForegroundColor White
...
2. 🎯 Create Flows:" -ForegroundColor Yellow
    ...
    Write-Host "   • Use 'EnterpriseKnowledgeHub' connector in new flows" -ForegroundColor White
    Write-Host "   • Available operations: 5 endpoints" -ForegroundColor White
    
    Write-Host "
3. 📱 Build Apps:" -ForegroundColor Yellow
    Write-Host "   • Power Apps: https://make.powerapps.com/" -ForegroundColor White
    Write-Host "   • Add 'EnterpriseKnowledgeHub' as data source" -ForegroundColor White
...
4. 🤖 M365 Copilot Integration:" -ForegroundColor Yellow
    ...
    Write-Host "   • Category: Knowledge Management" -ForegroundColor White
}

# Main deployment execution
function Main {
    Write-Host "
🎯 Starting EnterpriseKnowledgeHub deployment..." -ForegroundColor Green
    
    # Deploy connector
    $connectorDeployed = Deploy-EnterpriseKnowledgeHubConnector
...
❌ Deployment failed!" -ForegroundColor Red
    ...
    # Test connector
    $connectorTested = Test-EnterpriseKnowledgeHubConnector
...
⚠️  Connector deployed but health check failed" -ForegroundColor Yellow
    ...
    Write-Host "
🎉 EnterpriseKnowledgeHub deployment complete!" -ForegroundColor Green
    Write-Host "🔍 Your EnterpriseKnowledgeHub plugin is ready to use!" -ForegroundColor Green
}
